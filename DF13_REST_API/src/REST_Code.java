...
public class REST_Code extends Object {
    ...
    private static final String userName = "prem@df14.com"; // COPY USERNAME
    private static final String password = "Passwordtoken1jIJKv0DW2cVXFLE5"; // COPY PASSWORD AND TOKEN
    ...
    class UserCredentials {
        String loginInstanceDomain = "premdf-dev-ed.my.salesforce.com"; // COPY YOUR SERVER INSTANCE
